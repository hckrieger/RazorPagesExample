...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20211003144625_initialUploadToDb')
BEGIN
...
BEGIN
    ...
    VALUES (N'20211003144625_initialUploadToDb', N'5.0.10');
END;
GO
